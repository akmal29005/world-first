...
const Globe: React.FC<GlobeProps> = ({ stories, onStoryClick, onMapClick, isAddingMode }) => {
  ...
  useEffect(() => {
    ...
    // We attach this to SVG background or listen on svg directly for moves
    svg.on("mousemove", (event) => {
      ...
      // Optimization: Could use a quadtree or voronoi if too slow, but for 110m it's okay
  ...
  }, [worldData, rotation, zoomLevel, stories, isAddingMode, onStoryClick, onMapClick, countryNames, hoveredCountry]); 
